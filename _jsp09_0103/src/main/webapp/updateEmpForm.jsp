...
List<Dept> dlist = edd.selectDeptTemp();
...
<body>
	<form action="updateEmp.jsp" method="post">
		<table border="1">
			<tr>
				<td>사번</td>
				<td><input readonly type="text" name="empno" value=<%=emp.getEmpno()%>></td>
			</tr>
			<tr>
				<td>이름</td>
			...
			<tr>
				...
				<td><select name="deptno">
						...
						%>
						<option selected value=<%=dept.getDeptno()%>><%=dept.getDname()%></option>
						<%
							} else {
						%>
